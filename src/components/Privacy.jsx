...
const Privacy = () => {
  ...
  return (
    <div className="p-2 max-w-[800px] m-auto">
      ...
      <h3 className="text-2xl py-2">Server-Log-Dateien</h3>{" "}
      <p className="py-2">
      ...
      <ul className="py-2">
        {" "}
        <li className="py-2">Browsertyp und Browserversion</li>{" "}
        <li className="py-2">verwendetes Betriebssystem</li>{" "}
        <li>Referrer URL</li>{" "}
        <li className="py-2">Hostname des zugreifenden Rechners</li>{" "}
        <li className="py-2">Uhrzeit der Serveranfrage</li> <li>IP-Adresse</li>{" "}
      </ul>{" "}
      <p className="py-2">
