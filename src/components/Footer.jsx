        ...
        <div className="text-right">
          <div className="w-full flex justify-end">
            <div className="w-full md:w-[300px] py-4 relative">
              <div className="flex justify-center md:justify-end p-4 md:py-0 md:pb-4 mt-[-1rem]">
                <ThemeToggle />
              </div>
              ...
              <div className="py-4">
                <form>
                  <input
                    className="bg-primary border border-input py-2 mr-2 w-full shadow-xl rounded-2xl md:w-auto"
                    type="email"
